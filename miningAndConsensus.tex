...
In \Cref{sec:blockverbreitung} wird beschrieben wie jeder Knoten im Netzwerk den längsten Block auswählt. Die längste Kette bedeutet durch das Proof-of-Work Verfahren auch, das die Kette durch dei größte Menge Hashing Power erstellt wurde. Im Netzwerk entsteht so Konsens über den aktuell gültigen Stand der Blockchain und somit darüber welche Geldmittel bereits ausgegeben wurden und welche nicht. Es kann dabei wie in \Cref{sec:blockverbreitung} gezeigt zu temporären Blockchain Forks kommen. Die Ursache hierfür können zum Beispiel unehrliche....
